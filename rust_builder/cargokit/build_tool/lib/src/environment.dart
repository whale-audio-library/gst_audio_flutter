...
class Environment {
  ...
  static String? get gstreamerRootAndroid =>
      _getOptionalEnvPath("GSTREAMER_ROOT_ANDROID");
  static String? get gstreamerRootWindows => _getFirstOptionalEnvPath([
        "GSTREAMER_ROOT_WINDOWS",
  ...
  static String? _getOptionalEnvPath(String key) {
    final res = Platform.environment[key];
  ...
  static String? _getFirstOptionalEnvPath(List<String> keys) {
    for (final key in keys) {
      final value = _getOptionalEnvPath(key);
      if (value != null) {
        return value;
      }
    }
