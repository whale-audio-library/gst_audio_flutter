...
function(apply_cargokit target manifest_dir lib_name any_symbol_name)
    ...
    if (WIN32)
        set(CARGOKIT_GSTREAMER_ROOT_WINDOWS "")
        if (DEFINED GSTREAMER_ROOT_WINDOWS AND NOT "${GSTREAMER_ROOT_WINDOWS}" STREQUAL "")
            set(CARGOKIT_GSTREAMER_ROOT_WINDOWS "${GSTREAMER_ROOT_WINDOWS}")
        elseif (DEFINED ENV{GSTREAMER_ROOT_WINDOWS} AND NOT "$ENV{GSTREAMER_ROOT_WINDOWS}" STREQUAL "")
            set(CARGOKIT_GSTREAMER_ROOT_WINDOWS "$ENV{GSTREAMER_ROOT_WINDOWS}")
        elseif (DEFINED ENV{GSTREAMER_1_0_ROOT_MSVC_X86_64} AND NOT "$ENV{GSTREAMER_1_0_ROOT_MSVC_X86_64}" STREQUAL "")
            set(CARGOKIT_GSTREAMER_ROOT_WINDOWS "$ENV{GSTREAMER_1_0_ROOT_MSVC_X86_64}")
        elseif (DEFINED ENV{GSTREAMER_1_0_ROOT_X86_64} AND NOT "$ENV{GSTREAMER_1_0_ROOT_X86_64}" STREQUAL "")
            set(CARGOKIT_GSTREAMER_ROOT_WINDOWS "$ENV{GSTREAMER_1_0_ROOT_X86_64}")
        endif()

        if (NOT "${CARGOKIT_GSTREAMER_ROOT_WINDOWS}" STREQUAL "")
            file(TO_CMAKE_PATH "${CARGOKIT_GSTREAMER_ROOT_WINDOWS}" CARGOKIT_GSTREAMER_ROOT_WINDOWS)
            list(APPEND CARGOKIT_ENV "GSTREAMER_ROOT_WINDOWS=${CARGOKIT_GSTREAMER_ROOT_WINDOWS}")
        endif()
    endif()
